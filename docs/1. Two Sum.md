...
- LeetCode contract: usually guarantees exactly one solution — you can return immediately when found. If not guaranteed, return an empty result or throw as needed.
